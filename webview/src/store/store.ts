...
const initialState = {
  ...
  settings: { systemPrompt: "", enabledTools: {}, autoApprove: false, expandThinking: false, autoExpandBash: false, autoExpandEdit: false, autoExpandError: true, soundOnComplete: true, sendOnEnter: true },
